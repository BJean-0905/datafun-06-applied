...
Data Source:
- data/raw/airline-safety.csv (<https://raw.githubusercontent.com/fivethirtyeight/data/master/airline-safety/airline-safety.csv>)
...
DATASET_NAME: Final[str] = "airline-safety"
...
EXAMPLE_NUMERIC_COL: Final[str] = "avail_seat_km_per_week"
...
SCATTER_X_COL: Final[str] = "fatalities_85_99"
SCATTER_Y_COL: Final[str] = "fatalities_00_14"

BOX_Y_COL: Final[str] = "fatalities_00_14"

# CUSTOM: Assign readable labels for the charted variables.

SCATTER_X_LABEL: Final[str] = "Fatalities (1985-1999)"
SCATTER_Y_LABEL: Final[str] = "Fatalities (2000-2014)"

BOX_Y_LABEL: Final[str] = "Fatalities (1985-2014)"
...
def summarize(df: pd.DataFrame, df_clean: pd.DataFrame) -> None:
    ...
    LOG.info("======================")
    LOG.info("Look for interesting patterns in the charts. ")
    LOG.info("Repeat the process, exploring additional angles.")
    LOG.info("After finding interesting insights, conclude your analysis.")
    LOG.info("======================")
